...
var KTGeneralFullCalendarLocalesDemos = function () {
    ...
    var examplelocales = function () {
        ...
        var localeSelectorEl = document.getElementById('seleccionar_zona_calendario_uno_customizadoo');
        var calendarEl = document.getElementById('calendario_uno_customizado');
        ...
        calendar.getAvailableLocaleCodes().forEach(function (localeCode) {
            ...
            //optionEl.selected = localeCode == 'es';
        ...
        $(localeSelectorEl).change();
        $(localeSelectorEl).prop('disabled', true);
